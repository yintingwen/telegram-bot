package com.dething.cloud.common.launch.log;

import com.dething.cloud.common.launch.log.publisher.UsualLogPublisher;
...
@Slf4j
@Component
public class KgLogger implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		log.info(serviceId + ": KgLogger init success!");
	}
}
